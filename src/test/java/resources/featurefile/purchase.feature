Feature: Search functionality
  As a user I want to purchase cheapest and costliest product
  from the saucedemo after sorting the products by Hight to Low filter.

  Scenario Outline: User navigates saucedemo page and complete the item purchas
    ...
    And I enter details firstname "<firstName>", lastName "<lastName>" and zipPostalCode "<PostalCode>"
